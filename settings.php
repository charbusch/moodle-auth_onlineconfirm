...
if ($ADMIN->fulltree) {
    ...
    // Email new users to email.
    $settings->add(new admin_setting_configtext('auth_onlineconfirm/emailnew',
        get_string('auth_onlineconfirm_emailnew', 'auth_onlineconfirm'),
        get_string('auth_onlineconfirm_emailnew_description', 'auth_onlineconfirm'), '', PARAM_RAW_TRIMMED));
